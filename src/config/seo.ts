...
export const seoConfig: SeoConfig = {
  ...
  categories: {
    crossbody: {
      ...
      description:
        "Женские сумки кросс-боди из натуральной кожи и замши. Через плечо — удобно и стильно.",
    },
    "na-plecho": {
      name: "На плечо",
      title: "Сумки на плечо из натуральной кожи — купить | Moranti",
      description:
        "Классические сумки на плечо из натуральной кожи. Повседневные модели, которые сочетаются с любым гардеробом.",
    },
    baguette: {
      name: "Багет",
      title: "Сумки-багет из кожи и замши — купить | Moranti",
      description:
        "Компактные сумки-багет из натуральной кожи и замши. Городские модели с ремешком через плечо.",
    },
    tote: {
      name: "Тоут",
      title: "Сумки-тоуты из натуральной кожи — купить | Moranti",
      description:
        "Шоперы и тоуты из натуральной кожи и замши. Вместительные сумки для работы, учёбы и шопинга.",
    },
    saddle: {
      name: "Седло",
      title: "Сумки-седло из натуральной кожи — купить | Moranti",
      description:
        "Оригинальные сумки-седло из натуральной кожи. Модели в стиле casual с характерным изгибом.",
    },
    backpack: {
      name: "Рюкзаки",
      title: "Кожаные рюкзаки — купить | Moranti",
      description:
        "Рюкзаки из натуральной кожи: компактные городские и вместительные. Удобно носить каждый день.",
    },
  },

  product: {
    /** "{name}{color} — купить | Moranti". Без цены: динамика вредит сниппету (Google кеширует) */
    titleTemplate: "{name}{color} — купить | Moranti",
    /** "{name}{color} — Moranti" (для openGraph) */
    ogTitleTemplate: "{name}{color} — Moranti",
    /**
     * "Женская {name}{compositionPart}.{colorPart} Доставка по России — Moranti."

...
// Новые товары появляются в БД синком чаще, чем деплои: слаги вне
// generateStaticParams генерируются по запросу (ISR 60с кеширует дальше),
// а несуществующие отсекаются notFound() в generateMetadata и page.

      ...
      <div className={styles.page}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.body}>
            ...
            <p className={styles.text}>
              Сайт является витриной бренда. Покупка возможна двумя способами:
              на маркетплейсах Wildberries и Ozon (по их правилам) либо
              напрямую на сайте — через корзину и личный кабинет. При покупке на
              маркетплейсах персональные данные обрабатывает маркетплейс.
              При регистрации и оформлении заказа на сайте оператор обрабатывает
              данные, перечисленные в разделе 03.
            </p>
          </div>
        </section>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.body}>
            <ul className={styles.list}>
              ...
              <li>
                Данные учётной записи личного кабинета — e-mail, имя, фамилия,
                телефон. Пароль хранится исключительно в виде необратимого
                хэша и не доступен даже оператору.
              </li>
              <li>
                Данные заказа при оформлении через корзину — состав заказа,
                ФИО, телефон, e-mail, адрес доставки, выбранный способ доставки
                и оплаты. Необходимы для исполнения заказа.
              </li>
            </ul>
            <p className={styles.text}>
              Персональные данные запрашивают три формы: «Задать вопрос»
              (e-mail для ответа), регистрация в личном кабинете и оформление
              заказа (данные, необходимые для доставки). Иные персональные
              данные, позволяющие идентифицировать посетителя, оператором не
              запрашиваются.
            </p>
          </div>
        </section>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.body}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                Данные учётной записи и заказа обрабатываются для исполнения
                договора, стороной которого является посетитель, — покупки
                товара (п. 5 ч. 1 ст. 6 152-ФЗ) и для работы личного кабинета.
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.body}>
            <ul className={styles.list}>
              ...
              <li>
                При первом посещении сайта показывается баннер согласия на
                использование файлов cookie. Продолжая пользоваться сайтом
                после нажатия «Хорошо», вы соглашаетесь с применением cookie
                в объёме, описанном в этом разделе. Служебные cookie
                обеспечивают работу корзины, избранного и входа в личный
                кабинет.
              </li>
            </ul>
          </div>
          ...
          <div className={styles.body}>
            <ul className={styles.list}>
              ...
              <li>
                ...
                (по обращению через VK или в личном кабинете).
              </li>
              <li>
                Данные заказов — до достижения целей обработки, но не дольше

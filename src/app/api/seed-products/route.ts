  ...
  const defaultPages = [
    {
      slug: 'home',
      title: 'Главная',
      // Главная выглядит ровно как на проде: Hero + Новинки + Популярные +
      // Коллекции + CTA. Блоков не добавляем — при желании их можно
      // добавить в админке (Страницы → Главная), они появятся под Hero.
      layout: [],
    },
    {
      slug: 'o-nas',

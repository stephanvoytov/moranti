...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_orders_status" AS ENUM('new', 'processing', 'completed', 'cancelled', 'refunded');
  CREATE TYPE "public"."enum_orders_payment_method" AS ENUM('yookassa', 'cod', 'invoice');
  CREATE TYPE "public"."enum_orders_payment_status" AS ENUM('pending', 'paid', 'failed');
  ...
  CREATE TYPE "public"."enum_site_content_social_platform" AS ENUM('vk', 'telegram', 'whatsapp');
  CREATE TYPE "public"."enum_site_settings_social_platform" AS ENUM('vk', 'telegram', 'whatsapp');
  ...
  CREATE TABLE "products" (
  	...
  	"wb_price" numeric,
  	"ozon_price" numeric,
  	"wb_original_price" numeric,
  	"ozon_original_price" numeric,
  	"model_id" integer,
  	"color_name" varchar,
  	"composition" varchar,
  	"rating" numeric,
  ...
  CREATE TABLE "site_content_social" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"platform" "enum_site_content_social_platform",
  	"url" varchar
  );
  
  CREATE TABLE "site_content" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar DEFAULT 'Глобальный контент',
  	"hero_title" varchar,
  	...
  	"contacts_city" varchar,
  	"contacts_phone" varchar,
  	"contacts_email" varchar,
  	"contacts_work_hours" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "site_settings" (
  	...
  	"hero_image" varchar,
  	"wb_api_key" varchar,
  	"ozon_client_id" varchar,
  	"ozon_api_key" varchar,
  	"smtp_host" varchar,
  	"smtp_port" numeric,
  	"smtp_user" varchar,
  	"smtp_pass" varchar,
  ...
  ALTER TABLE "models" ADD CONSTRAINT "models_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "site_content_social" ADD CONSTRAINT "site_content_social_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_content"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "models_category_idx" ON "models" USING btree ("category_id");
  ...
  CREATE INDEX "subscribers_tags_order_idx" ON "subscribers_tags" USING btree ("_order");
  CREATE INDEX "subscribers_tags_parent_id_idx" ON "subscribers_tags" USING btree ("_parent_id");
  ...
  CREATE INDEX "site_content_social_order_idx" ON "site_content_social" USING btree ("_order");
  CREATE INDEX "site_content_social_parent_id_idx" ON "site_content_social" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "site_content_social" CASCADE;
  ...
  DROP TYPE "public"."enum_site_content_social_platform";

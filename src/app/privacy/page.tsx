      ...
      <div className={styles.page}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.body}>
            ...
            <p className={styles.text}>
              Формы сбора имени, телефона или e-mail на сайте отсутствуют —
              персональные данные посетителей в объёме, позволяющем их
              идентифицировать, оператором не запрашиваются.
            </p>
          </div>
        </section>
